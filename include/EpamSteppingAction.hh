...
// ********************************************************************
//
/// \file optical/Epam/include/EpamSteppingAction.hh
/// \brief Definition of the EpamSteppingAction class
//
//
//
//
...
class EpamSteppingActionMessenger;
...
class EpamSteppingAction : public G4UserSteppingAction
{
  public:
    ...
    EpamSteppingAction(MirrorDetectorConstruction*);
    ~EpamSteppingAction();
  ...
  private:
    ...
    EpamSteppingActionMessenger* steppingMessenger;
