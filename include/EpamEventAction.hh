...
// ********************************************************************
//
/// \file optical/Epam/include/EpamEventAction.hh
/// \brief Definition of the EpamEventAction class
//
//
//
//
...
class EpamRunAction;
class EpamEventActionMessenger;

class EpamEventAction : public G4UserEventAction
{
  public:

    EpamEventAction(EpamRunAction*);
    ~EpamEventAction();
  ...
  private:
    ...
    EpamEventActionMessenger* eventMessenger;
