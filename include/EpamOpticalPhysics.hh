...
#ifndef EpamOpticalPhysics_h
#define EpamOpticalPhysics_h 1
...
class EpamOpticalPhysics : public G4VPhysicsConstructor
{
  public:

    EpamOpticalPhysics(G4bool toggle=true);
    virtual ~EpamOpticalPhysics();
