...
// ********************************************************************
//
/// \file optical/Epam/src/EpamPrimaryGeneratorMessenger.cc
/// \brief Implementation of the EpamPrimaryGeneratorMessenger class
//
//
//
...
EpamPrimaryGeneratorMessenger::
                   EpamPrimaryGeneratorMessenger(EpamPrimaryGeneratorAction* gun)
  : action(gun)
{
  gunDir = new G4UIdirectory("/Epam/gun/");
  gunDir->SetGuidance("EpamPrimaryGenerator control");

  SetPolarizationCmd =
                 new G4UIcmdWithADoubleAndUnit("/Epam/gun/optPhotonPolar",this);
  ...
  SetDecayTimeConstantCmd =
           new G4UIcmdWithADoubleAndUnit("/Epam/gun/setDecayTimeConstant",this);
...
EpamPrimaryGeneratorMessenger::~EpamPrimaryGeneratorMessenger()
{
  delete gunDir;
...
void EpamPrimaryGeneratorMessenger::
