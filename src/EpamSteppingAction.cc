...
// ********************************************************************
//
/// \file optical/Epam/src/EpamSteppingAction.cc
/// \brief Implementation of the EpamSteppingAction class
//
//
//
...
#include "EpamSteppingActionMessenger.hh"
//#include "EpamPhotonDetSD.hh"

#include "G4ParticleTypes.hh"

#include "EpamUserTrackInformation.hh"
...
EpamSteppingAction::EpamSteppingAction(MirrorDetectorConstruction* DC)
  : detector(DC)
{
  steppingMessenger = new EpamSteppingActionMessenger(this);
...
void  EpamSteppingAction::SetBounceLimit(G4int i)   {bounceLimit = i;}
G4int EpamSteppingAction::GetNumberOfBounces()      {return counterBounce;}
G4int EpamSteppingAction::GetNumberOfClad1Bounces() {return counterClad1Bounce;}
G4int EpamSteppingAction::GetNumberOfClad2Bounces() {return counterClad2Bounce;}
G4int EpamSteppingAction::GetNumberOfWLSBounces()   {return counterWLSBounce;}
G4int EpamSteppingAction::ResetSuccessCounter()     {
...
inline void EpamSteppingAction::saveRandomStatus(G4String subDir) {
 
    // don't save if the maximum amount has been reached
    if (EpamSteppingAction::maxRndmSave == 0) return;
    ...
    EpamSteppingAction::maxRndmSave--;
}

void EpamSteppingAction::UpdateHistogramSuccess(G4StepPoint* ,G4Track* ) {}

void EpamSteppingAction::UpdateHistogramReflect(G4StepPoint* ,G4Track* ) {}

void EpamSteppingAction::UpdateHistogramEscape(G4StepPoint* , G4Track* ) {}

void EpamSteppingAction::UpdateHistogramAbsorb(G4StepPoint* , G4Track* ) {}

void EpamSteppingAction::UserSteppingAction(const G4Step* theStep)
{
  G4Track* theTrack = theStep->GetTrack();
  EpamUserTrackInformation* trackInformation
      = (EpamUserTrackInformation*)theTrack->GetUserInformation();
...
/*
     case Detection:
       ...
       if ( thePostPVname == "PhotonDet" ) {
          ...
          G4String SDname="Epam/PhotonDet";
          EpamPhotonDetSD* mppcSD =
                        (EpamPhotonDetSD*)SDman->FindSensitiveDetector(SDname);
