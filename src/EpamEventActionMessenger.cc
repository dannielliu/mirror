...
// ********************************************************************
//
/// \file optical/Epam/src/EpamEventActionMessenger.cc
/// \brief Implementation of the EpamEventActionMessenger class
//
//
//
...
EpamEventActionMessenger::EpamEventActionMessenger(EpamEventAction* EvAct)
     :eventAction(EvAct)
{
...
EpamEventActionMessenger::~EpamEventActionMessenger()
{
...
void EpamEventActionMessenger::SetNewValue(G4UIcommand* command,
                                          G4String newValue)
{
