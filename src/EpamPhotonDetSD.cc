...
// ********************************************************************
//
/// \file optical/Epam/src/EpamPhotonDetSD.cc
/// \brief Implementation of the EpamPhotonDetSD class
//
//
//
...
EpamPhotonDetSD::EpamPhotonDetSD(G4String name)
  : G4VSensitiveDetector(name),PhotonDetHitCollection(0)
{
  collectionName.insert("PhotonDetHitCollection");
}

EpamPhotonDetSD::~EpamPhotonDetSD() { }

void EpamPhotonDetSD::Initialize(G4HCofThisEvent* HCE)
{
  PhotonDetHitCollection =
       new EpamPhotonDetHitsCollection(SensitiveDetectorName,collectionName[0]);
...
G4bool EpamPhotonDetSD::ProcessHits(G4Step* , G4TouchableHistory* )
{
  return false;
}
...
G4bool EpamPhotonDetSD::ProcessHits_constStep(const G4Step* aStep,
                                             G4TouchableHistory* )
{
  ...
  PhotonDetHitCollection->
            insert(new EpamPhotonDetHit(photonExit, photonArrive, arrivalTime));

  return true;
}

void EpamPhotonDetSD::EndOfEvent(G4HCofThisEvent* ){ }

void EpamPhotonDetSD::clear(){ }

void EpamPhotonDetSD::DrawAll(){ }

void EpamPhotonDetSD::PrintAll(){ }
