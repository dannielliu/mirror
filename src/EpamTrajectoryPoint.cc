...
// ********************************************************************
//
/// \file optical/Epam/src/EpamTrajectoryPoint.cc
/// \brief Implementation of the EpamTrajectoryPoint class
//
//
//
...
G4Allocator<EpamTrajectoryPoint> EpamTrajPointAllocator;

EpamTrajectoryPoint::EpamTrajectoryPoint()
      : fTime(0.), fMomentum(0.,0.,0.),
        fStepStatus(fUndefined), fVolumeName("") { }

EpamTrajectoryPoint::EpamTrajectoryPoint(const G4Step* aStep)
...
EpamTrajectoryPoint::EpamTrajectoryPoint(const G4Track* aTrack)
...
EpamTrajectoryPoint::EpamTrajectoryPoint(const EpamTrajectoryPoint &right)
...
const std::map<G4String,G4AttDef>* EpamTrajectoryPoint::GetAttDefs() const
{
  G4bool isNew;
...
std::vector<G4AttValue>* EpamTrajectoryPoint::CreateAttValues() const
{
