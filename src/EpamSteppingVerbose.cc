...
// ********************************************************************
//
/// \file optical/Epam/src/EpamSteppingVerbose.cc
/// \brief Implementation of the EpamSteppingVerbose class
//
//
//
...
EpamSteppingVerbose::EpamSteppingVerbose()
{
...
void EpamSteppingVerbose::StepInfo()
{
  CopyState();
...
void EpamSteppingVerbose::TrackingStarted()
{
  CopyState();
