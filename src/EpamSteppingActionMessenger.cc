...
// ********************************************************************
//
/// \file optical/Epam/src/EpamSteppingActionMessenger.cc
/// \brief Implementation of the EpamSteppingActionMessenger class
//
//
//
...
EpamSteppingActionMessenger::EpamSteppingActionMessenger(EpamSteppingAction* SA)
  : steppingAction (SA)
{
...
EpamSteppingActionMessenger::~EpamSteppingActionMessenger()
{
  delete steppingDir;
  delete SetBounceLimitCmd;
}

void EpamSteppingActionMessenger::SetNewValue(G4UIcommand* command,
                                             G4String newValue)
{
