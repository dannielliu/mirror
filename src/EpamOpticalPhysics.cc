...
// ********************************************************************
//
/// \file optical/Epam/src/EpamOpticalPhysics.cc
/// \brief Implementation of the EpamOpticalPhysics class
//
//
//
//
...
EpamOpticalPhysics::EpamOpticalPhysics(G4bool toggle)
...
EpamOpticalPhysics::~EpamOpticalPhysics() { }
...
void EpamOpticalPhysics::ConstructParticle()
{
...
void EpamOpticalPhysics::ConstructProcess()
{
    G4cout << "EpamOpticalPhysics:: Add Optical Physics Processes"
           << G4endl;
...
void EpamOpticalPhysics::SetNbOfPhotonsCerenkov(G4int MaxNumber)
{
