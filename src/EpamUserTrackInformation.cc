...
// ********************************************************************
//
/// \file optical/Epam/src/EpamUserTrackInformation.cc
/// \brief Implementation of the EpamUserTrackInformation class
//
//
//
...
EpamUserTrackInformation::EpamUserTrackInformation ()
{
   status = undefined;
...
G4bool EpamUserTrackInformation::AddStatusFlag(TrackStatus s)
{
   switch (s) {
