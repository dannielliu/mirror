...
// ********************************************************************
//
/// \file optical/Epam/src/EpamRunActionMessenger.cc
/// \brief Implementation of the EpamRunActionMessenger class
//
//
//
...
EpamRunActionMessenger::EpamRunActionMessenger(EpamRunAction* RA)
  : runAction (RA)
{
...
EpamRunActionMessenger::~EpamRunActionMessenger()
{
  delete RndmDir; delete RndmSaveCmd; delete RndmReadCmd; delete SetAutoSeedCmd;
}

void EpamRunActionMessenger::SetNewValue(G4UIcommand* command,G4String newValue)
{
